...
export const SYSTEM_CATEGORIES: Omit<Category, 'createdAt'>[] = [
  ...
  { id: 'sys-other-ex', name: '其他',   icon: 'category', type: 'expense', isSystem: true, sortOrder: 7 },
  { id: 'sys-salary',   name: '工资',   icon: 'briefcase', type: 'income',  isSystem: true, sortOrder: 8 },
  { id: 'sys-freelance',name: '兼职',   icon: 'coins', type: 'income',  isSystem: true, sortOrder: 9 },
  { id: 'sys-other-in', name: '其他收入',icon: 'gift', type: 'income', isSystem: true, sortOrder: 10 },
]
